...
goog.provide("tic_tac");
goog.require("cljs.core");
tic_tac.init_canvas = function init_canvas(canvas) {
  var G__4824 = canvas;
  G__4824["width"] = canvas.clientWidth;
  G__4824["height"] = canvas.clientHeight;
  return G__4824
};
tic_tac.canvas = tic_tac.init_canvas.call(null, document.getElementById("board"));
tic_tac.height = tic_tac.canvas.clientHeight;
tic_tac.width = tic_tac.canvas.clientWidth;
tic_tac.cell_height = tic_tac.height / 10;
tic_tac.cell_width = tic_tac.width / 10;
tic_tac.context = tic_tac.canvas.getContext("2d");
tic_tac.moves = cljs.core.atom.call(null, cljs.core.PersistentHashSet.EMPTY);
tic_tac.current_color = cljs.core.atom.call(null, cljs.core.cycle.call(null, cljs.core.PersistentVector.fromArray(["red", "brown"], true)));
tic_tac.draw_rect = function draw_rect(context, color, x, y, w, h) {
  var G__4826 = context;
  G__4826["fillStyle"] = color;
  G__4826.fillRect(x, y, w, h);
  return G__4826
};
tic_tac.draw_line = function draw_line(context, color, x1, y1, x2, y2) {
  var G__4828 = context;
  G__4828["strokeStyle"] = color;
  G__4828.beginPath();
  G__4828.moveTo(x1, y1);
  G__4828.lineTo(x2, y2);
  G__4828.stroke();
  return G__4828
};
var w_4837 = tic_tac.cell_width;
var h_4838 = tic_tac.cell_height;
var seq__4829_4839 = cljs.core.seq.call(null, cljs.core.range.call(null, w_4837, tic_tac.width, w_4837));
var chunk__4830_4840 = null;
var count__4831_4841 = 0;
var i__4832_4842 = 0;
while(true) {
  if(i__4832_4842 < count__4831_4841) {
    var i_4843 = cljs.core._nth.call(null, chunk__4830_4840, i__4832_4842);
    tic_tac.draw_line.call(null, tic_tac.context, "red", i_4843, 0, i_4843, tic_tac.height);
    var G__4844 = seq__4829_4839;
    var G__4845 = chunk__4830_4840;
    var G__4846 = count__4831_4841;
    var G__4847 = i__4832_4842 + 1;
    seq__4829_4839 = G__4844;
    chunk__4830_4840 = G__4845;
    count__4831_4841 = G__4846;
    i__4832_4842 = G__4847;
    continue
  }else {
    var temp__4092__auto___4848 = cljs.core.seq.call(null, seq__4829_4839);
    if(temp__4092__auto___4848) {
      var seq__4829_4849__$1 = temp__4092__auto___4848;
      if(cljs.core.chunked_seq_QMARK_.call(null, seq__4829_4849__$1)) {
        var c__3844__auto___4850 = cljs.core.chunk_first.call(null, seq__4829_4849__$1);
        var G__4851 = cljs.core.chunk_rest.call(null, seq__4829_4849__$1);
        var G__4852 = c__3844__auto___4850;
        var G__4853 = cljs.core.count.call(null, c__3844__auto___4850);
        var G__4854 = 0;
        seq__4829_4839 = G__4851;
        chunk__4830_4840 = G__4852;
        count__4831_4841 = G__4853;
        i__4832_4842 = G__4854;
        continue
      }else {
        var i_4855 = cljs.core.first.call(null, seq__4829_4849__$1);
        tic_tac.draw_line.call(null, tic_tac.context, "red", i_4855, 0, i_4855, tic_tac.height);
        var G__4856 = cljs.core.next.call(null, seq__4829_4849__$1);
        var G__4857 = null;
        var G__4858 = 0;
        var G__4859 = 0;
        seq__4829_4839 = G__4856;
        chunk__4830_4840 = G__4857;
        count__4831_4841 = G__4858;
        i__4832_4842 = G__4859;
        continue
      }
    }else {
    }
...
var seq__4833_4860 = cljs.core.seq.call(null, cljs.core.range.call(null, h_4838, tic_tac.height, h_4838));
var chunk__4834_4861 = null;
var count__4835_4862 = 0;
var i__4836_4863 = 0;
while(true) {
  if(i__4836_4863 < count__4835_4862) {
    var i_4864 = cljs.core._nth.call(null, chunk__4834_4861, i__4836_4863);
    tic_tac.draw_line.call(null, tic_tac.context, "red", 0, i_4864, tic_tac.width, i_4864);
    var G__4865 = seq__4833_4860;
    var G__4866 = chunk__4834_4861;
    var G__4867 = count__4835_4862;
    var G__4868 = i__4836_4863 + 1;
    seq__4833_4860 = G__4865;
    chunk__4834_4861 = G__4866;
    count__4835_4862 = G__4867;
    i__4836_4863 = G__4868;
    continue
  }else {
    var temp__4092__auto___4869 = cljs.core.seq.call(null, seq__4833_4860);
    if(temp__4092__auto___4869) {
      var seq__4833_4870__$1 = temp__4092__auto___4869;
      if(cljs.core.chunked_seq_QMARK_.call(null, seq__4833_4870__$1)) {
        var c__3844__auto___4871 = cljs.core.chunk_first.call(null, seq__4833_4870__$1);
        var G__4872 = cljs.core.chunk_rest.call(null, seq__4833_4870__$1);
        var G__4873 = c__3844__auto___4871;
        var G__4874 = cljs.core.count.call(null, c__3844__auto___4871);
        var G__4875 = 0;
        seq__4833_4860 = G__4872;
        chunk__4834_4861 = G__4873;
        count__4835_4862 = G__4874;
        i__4836_4863 = G__4875;
        continue
      }else {
        var i_4876 = cljs.core.first.call(null, seq__4833_4870__$1);
        tic_tac.draw_line.call(null, tic_tac.context, "red", 0, i_4876, tic_tac.width, i_4876);
        var G__4877 = cljs.core.next.call(null, seq__4833_4870__$1);
        var G__4878 = null;
        var G__4879 = 0;
        var G__4880 = 0;
        seq__4833_4860 = G__4877;
        chunk__4834_4861 = G__4878;
        count__4835_4862 = G__4879;
        i__4836_4863 = G__4880;
        continue
      }
    }else {
    }
...
tic_tac.mouse_pos = function mouse_pos(canvas, event) {
  var rect = canvas.getBoundingClientRect();
  return cljs.core.PersistentVector.fromArray([event.clientX - rect.left, event.clientY - rect.top], true)
};
tic_tac.coord_to_cell = function coord_to_cell(xy) {
  return cljs.core.PersistentVector.fromArray([Math.floor(cljs.core.get.call(null, xy, 0) / tic_tac.cell_width), Math.floor(cljs.core.get.call(null, xy, 1) / tic_tac.cell_height)], true)
};
tic_tac.paint_cell = function paint_cell(x, y) {
  return tic_tac.draw_rect.call(null, tic_tac.context, "green", x * tic_tac.cell_width, y * tic_tac.cell_height, tic_tac.cell_width - 1, tic_tac.cell_height - 1)
};
tic_tac.canvas.addEventListener("click", function(event) {
  var vec__4881 = tic_tac.coord_to_cell.call(null, tic_tac.mouse_pos.call(null, tic_tac.canvas, event));
  var mx = cljs.core.nth.call(null, vec__4881, 0, null);
  var my = cljs.core.nth.call(null, vec__4881, 1, null);
  tic_tac.paint_cell.call(null, mx, my);
  cljs.core.swap_BANG_.call(null, tic_tac.moves, cljs.core.conj, cljs.core.PersistentVector.fromArray([mx, my], true));
  console.log([cljs.core.str(cljs.core.deref.call(null, tic_tac.current_color))].join(""));
  return console.log([cljs.core.str(cljs.core.deref.call(null, tic_tac.moves))].join(""))
});
